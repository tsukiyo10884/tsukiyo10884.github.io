const showCollection = (data) => {
    ...
    $('#circle-bg').attr('src', data.circleImg);
    ...
    if (data.charactersLevel[0].reborn > 0) {
        $('#leader-bar').attr('src', '/mai-tools/img/collection/member_rainbow_bar.webp');
    } else if (data.charactersLevel[0].lv >= 1 && data.charactersLevel[0].lv <= 8) {
        $('#leader-bar').attr('src', '/mai-tools/img/collection/member_blue_bar.webp');
    } else if (data.charactersLevel[0].lv >= 9 && data.charactersLevel[0].lv <= 48) {
        $('#leader-bar').attr('src', '/mai-tools/img/collection/member_green_bar.webp');
    } else if (data.charactersLevel[0].lv >= 49 && data.charactersLevel[0].lv <= 98) {
        $('#leader-bar').attr('src', '/mai-tools/img/collection/member_red_bar.webp');
    } else if (data.charactersLevel[0].lv >= 99 && data.charactersLevel[0].lv <= 298) {
        $('#leader-bar').attr('src', '/mai-tools/img/collection/member_bronze_bar.webp');
    } else if (data.charactersLevel[0].lv >= 299 && data.charactersLevel[0].lv <= 998) {
        $('#leader-bar').attr('src', '/mai-tools/img/collection/member_silver_bar.webp');
    } else if (data.charactersLevel[0].lv >= 999 && data.charactersLevel[0].lv <= 9998) {
        $('#leader-bar').attr('src', '/mai-tools/img/collection/member_gold_bar.webp');
    }
    ...
    for (let i = 1; i < data.charactersLevel.length; i++) {
        if (data.charactersLevel[i].reborn > 0) {
            $('#' + dict[i] + '-bg').attr('src', '/mai-tools/img/collection/member_rainbow_bg.webp');
            $('#' + dict[i] + '-layout').attr('src', '/mai-tools/img/collection/member_rainbow_layout.webp');
        } else if (data.charactersLevel[i].lv >= 1 && data.charactersLevel[i].lv <= 8) {
            $('#' + dict[i] + '-bg').attr('src', '/mai-tools/img/collection/member_blue_bg.webp');
            $('#' + dict[i] + '-layout').attr('src', '/mai-tools/img/collection/member_blue_layout.webp');
        } else if (data.charactersLevel[i].lv >= 9 && data.charactersLevel[i].lv <= 48) {
            $('#' + dict[i] + '-bg').attr('src', '/mai-tools/img/collection/member_green_bg.webp');
            $('#' + dict[i] + '-layout').attr('src', '/mai-tools/img/collection/member_green_layout.webp');
        } else if (data.charactersLevel[i].lv >= 49 && data.charactersLevel[i].lv <= 98) {
            $('#' + dict[i] + '-bg').attr('src', '/mai-tools/img/collection/member_red_bg.webp');
            $('#' + dict[i] + '-layout').attr('src', '/mai-tools/img/collection/member_red_layout.webp');
        } else if (data.charactersLevel[i].lv >= 99 && data.charactersLevel[i].lv <= 298) {
            $('#' + dict[i] + '-bg').attr('src', '/mai-tools/img/collection/member_bronze_bg.webp');
            $('#' + dict[i] + '-layout').attr('src', '/mai-tools/img/collection/member_bronze_layout.webp');
        } else if (data.charactersLevel[i].lv >= 299 && data.charactersLevel[i].lv <= 998) {
            $('#' + dict[i] + '-bg').attr('src', '/mai-tools/img/collection/member_silver_bg.webp');
            $('#' + dict[i] + '-layout').attr('src', '/mai-tools/img/collection/member_silver_layout.webp');
        } else if (data.charactersLevel[i].lv >= 999 && data.charactersLevel[i].lv <= 9998) {
            $('#' + dict[i] + '-bg').attr('src', '/mai-tools/img/collection/member_gold_bg.webp');
            $('#' + dict[i] + '-layout').attr('src', '/mai-tools/img/collection/member_gold_layout.webp');
        }
    }
