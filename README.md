...
javascript:(function(){
    var css='default';
    var code="var s=document.createElement('script');s.src='https://tsukiyo10884.github.io/mai-tools/fetch_data.js?css=" 
    + css + "';document.body.appendChild(s);";   
    eval(code);
})();
```
...
#### 目前可用功能  
- 在首頁使用：擷取個人資料並可使用 R值表、R值候選曲、名牌板進度、等級進度 功能
- 在好友的主頁使用：擷取好友資料(但無法擷取自己未解鎖的歌曲)，並有如上功能
- 在萬花筒的各個門畫面使用：顯示該門及鑰匙獲得條件及進度
- 在Player Data使用：顯示目前Class、各階級加減分以及到達指定Class需進行的場數  
- 在收藏品使用：顯示目前裝備的收藏品在機台上組合起來的樣子
- 神秘功能：阿瑄專屬功能與阿幽蒼蠅小遊戲  
